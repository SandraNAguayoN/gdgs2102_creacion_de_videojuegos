...
## VideoJuego
  ...
  * > <a href="https://github.com/SandraNAguayoN/gdgs2102_creacion_de_videojuegos/blob/main/Proyecto%20Ali-en-Casa/"> Avance v1.1 </a>
    - Se modificó el Ground (suelo) para que no se mueva, el modelo del personaje se cambio y se agregó la animación de correr como estado inicial cuando toque el suelo y la animación de saltar cuando se presione la barra espaciadora.
  * Nivel 2 - Ramiro
